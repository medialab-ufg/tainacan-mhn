...
class MHNIIIF {
	...
	function filter_document($html, $item) {
		...
		return '<div class="openseadragon-wrapper-image"><img src="' . $this->get_option('iiif_base_url') . $id . '.jpg/full/!1000,800/0/default.jpg" /><a href="#" id="open-image-modal" class="mdi mdi-magnify-plus-outline"></a><span class="caption-image-modal">Imagem: Google/MHN</span></div>';
	}
